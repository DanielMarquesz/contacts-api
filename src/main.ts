...
import { GetAllContacts } from './domain/use-cases/contact/get-all'
import { ContactRepositoryImpl } from './domain/repositories/contact'
import { CreateContact } from './domain/use-cases/contact/create'
import { MongoClient } from 'mongodb'
// Fix Database
import { Database } from './data/interfaces/data-sources/'
